...
%             rmpath ./Boulder/WholesaleComp  % remove path
            ...
            addpath ./Boulder/WholesaleComp
            BO_WC_rp = dlmread('1_RetailPrice.csv' ,',','B2..AK2048'); % retail price
            BO_WC_rc = dlmread('2_RegularCust.csv' ,',','B2..AK2048'); % reg. customers
            BO_WC_pv = dlmread('3_Cust_With_PV.csv',',','B2..AK2048'); % pv customers
            BO_WC_de = dlmread('4_Defector.csv'    ,',','B2..AK2048'); % defectors
            rmpath ./Boulder/WholesaleComp  % remove path
